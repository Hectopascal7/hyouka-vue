<template>
    <div class="contactus-3 mt-6">
        <div class="page-header">
            <img class="bg-image" src="img/ill/header_contactus.svg" alt=""/>
        </div>
        <div class="container pt-5">
            <div class="row">
                <div class="col-md-12 text-center mb-5">
                    <h1 class="display-1 mt-8">Got a question?</h1>
                    <h3 class="lead">We'd like to talk more about what you need</h3>
                    <base-button type="success" icon="ni ni-chat-round" class="mt-3"
                    >Chat with us
                    </base-button
                    >
                </div>
